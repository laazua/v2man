...
urlpatterns = [
    ...
    path('invite/withdrawals/create/', views.CreateWithdrawalView.as_view()),
    path('admin/invite/settings/', views.SettingsView.as_view()),
    path('admin/invite/withdrawals/', views.AdminWithdrawalListView.as_view()),
    path('admin/invite/withdrawals/<int:pk>/action/', views.AdminWithdrawalActionView.as_view()),
]
