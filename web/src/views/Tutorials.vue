  ...
  <div class="tutorial-page">
    ...
    <div v-if="activeTab === 'v2ray'" class="guide">
      ...
      <section>
        ...
        <ol>
          <li>从 <a href="https://play.google.com/store/apps/details?id=com.v2ray.ang" target="_blank">Google Play</a> 或 GitHub 下载 V2RayNG</li>
    ...
    <div v-if="activeTab === 'singbox'" class="guide">
      ...
      <section>
        ...
        <ol>
          ...
          <li>GUI 客户端推荐：<a href="https://github.com/Firewallv2/Firewallv2/releases" target="_blank">Firewall</a>（Windows）、<a href="https://github.com/SagerNet/sing-box/releases" target="_blank">Sing-box</a>（macOS）</li>
    ...
    <div v-if="activeTab === 'shadowrocket'" class="guide">
      ...
      <section>
        ...
        <ol>
          <li>在 App Store 搜索 <strong>Shadowrocket</strong>（¥2.99，需美区/港区 Apple ID）</li>
    ...
    <div v-if="activeTab === 'stash'" class="guide">
      ...
      <section>
        <h3>iOS — Stash</h3>
        <ol>
          <li>在 App Store 搜索 <strong>Stash</strong>（¥2.99，需美区/港区 Apple ID）</li>
    ...
    <div v-if="!profile.subscription_token" class="no-token">
      <p>请先<a href="/plans">购买套餐</a>获取订阅链接后查看教程。</p>
    </div>
  </div>
</template>
...
.sub-row code { flex: 1; font-size: 0.7rem; word-break: break-all; color: var(--text-muted); }
...
.no-token { margin-top: 1rem; padding: 1rem; background: var(--bg-card); border-radius: var(--radius); border: 1px solid var(--border); text-align: center; color: var(--text-muted); }
.no-token a { color: var(--accent); }
</style>
